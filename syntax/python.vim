...
syn match   pythonFunction	"\<\h\w*\>\s*("me=e-1 display
...
" pointer operators - address of and dereference are context sensitive
syn match pythonDotOperator display "\."
...
syn match pythonLogicalOperator display "=="
" bit operators
syn match pythonBinaryOperator display "\(&\||\|\^\|<<\|>>\)=\="
syn match pythonBinaryOperator display "\~"
syn match pythonBinaryOperatorError display "\~="
syn cluster pythonOperator         contains=pythonMathOperator,pythonDotOperator,pythonLogicalOperator,pythonBinaryOperator
...
if version >= 508 || !exists("did_python_syn_inits")
  ...
  HiLink pythonVariable		Identifier
  ...
  HiLink pythonDotOperator		Operator
  HiLink pythonLogicalOperator		Operator
  HiLink pythonBinaryOperator		Operator

...
" Creator:      Mike Williams <mrw@eandem.co.uk>
" Maintainer:   Yuwei Yu <acevery@gmail.com>
" Filenames:    *.c,*.h
" Last Change:  31th Janury 2011
...
" 12.6 Make highlighting for user defined type.
...
" User defined types, have to add it after the Identifier
syn match         cUserType      "\(\(\<\h\w*\>\)\@>\s\+\<\h\w*\>\)\@=\2"
syn cluster       cType             add=cUserType

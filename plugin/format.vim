...
" 自行更改為 cp950 以適合繁體中文
" LastModified:   Yuwei Yu <acevery@gmail.com> 2008.12.12
"       Change the punctuation char length to 3 under UTF-8
...
"  let no_b = ''
"  let no_b = no_b . "� � 删 刹 瞯 � � � 丢 丬 内 匀 匤 卟 厰 吣 劒 "
"  let no_b = no_b . "� 篭 倶 殖 具 嬶 廰 弌 弡 徃 伜 侊 兊 兑 "
"  let no_b = no_b . "幺 収 低 囱 夹 邸 � � � � � � "
"  let no_b = no_b . "亊 冦 僴 儖 仼 � 剱 乕 乢 亰 仫 仭 劜 劵 刋 凛 "

"  let no_e = ''
"  let no_e = no_e . "� 刕 别 勐 匇 卆 厓 叝 劐 � 剏 劔 劯 � "
...
function! s:GetCharUnderCursor()
  ...
  let ch = str[idx]
  if char2nr(ch) >= 128
    return strpart(str, idx, 3) " should be 3 under UTF-8
  else
    return ch
  endif
endfunction
